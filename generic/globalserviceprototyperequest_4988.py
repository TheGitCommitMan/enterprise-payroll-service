...
class TestGlobalServicePrototypeRequest(unittest.TestCase):
    """Initializes the TestGlobalServicePrototypeRequest with the specified configuration parameters."""
